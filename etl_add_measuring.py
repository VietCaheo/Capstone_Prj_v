...
# ____________________measuring...____________________measuring...____________________measuring...
    # print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    # print("Measuring time execute for Creat for  D_USCities_table ... \n")
    # start_time = datetime.now()

    # end_time = datetime.now()

    # a = (str(end_time - start_time)).split(".")[0]
    # print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    # print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    # print(f"Executing duration Of Function Creat_D_USCities is ... : {a}")
    # # ____________________end for Profiling a function execute ...
# ____________________measuring...____________________measuring...____________________measuring...
...
def process_Immigra_data(spark, input_data):
    ...
    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring time execute for function MultipleRead_sas_files .... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Function MultipleRead_sas_files is ... : {a}")
    # ____________________end for Profiling a function execute ...
    ...
    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring executing time for `Creat table` DateTime_table + table_name.count() ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of functions `Creat table`  is ... : {a}")
    # ____________________end for Profiling a function execute ...


    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring executing time for  `Write Read` parquet + after_parquets_read.count() for DateTime_table  ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of functions `Write Read` parquet for DateTime_table  is ... : {a}")
    # ____________________end for Profiling a function execute ...
    ...
    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring time execute for Create + table_name.count() Fact_Immigrant_table ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Function Creat Fact_Immigrant_table is ... : {a}")
    # ____________________end for Profiling a function execute ...

    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring time execute for Write, Read parquet + Fact_Immigrant_table.count() after Read Parquet ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Function WRITE/READ parquet is ... : {a}")
    # ____________________end for Profiling a function execute ...
    ...
    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring time execute for Creat + tablename.count() for D_Immigrant_detail_table ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Function Creat for  D_Immigrant_detail_table is ... : {a}")
    # ____________________end for Profiling a function execute ...

    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring time execute for WRITE/READ parquet + table.count after read parquet  D_Immigrant_detail_table ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Function is ... : {a}")
    # ____________________end for Profiling a function execute ...
...
def process_UsCities_data(spark, input_data, port_mapto_city):
    ...
    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring time execute for WRITE/READ parquet for  D_USCities_table ... \n")
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of WRITE READ parquet for D_USCities is ... : {a}")
    # ____________________end for Profiling a function execute ...
...
def process_AirPort_data(spark, input_data, port_mapto_city):
    ...
    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring time execute for creat_D_Airport table ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Function creat_D_Airport is ... : {a}")
    # ____________________end for Profiling a function execute ...

    before_parquets_write = D_AirPort_table.count()

    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring time execute for WRITE/READ parquet files D_Airport table ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Function WRITE/READ parquet files D_Airport table is ... : {a}")
    # ____________________end for Profiling a function execute ...
...
def process_CityTemper_data(spark, input_data, port_mapto_city):
    ...
    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring for creat table dfS WorldTemp ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Function  creat table dfS WorldTemp   ... : {a}")
    # ____________________end for Profiling a function execute ...

    before_parquets_write = D_WorldTemp_table.count()

    print("\n \n \n____________________Profiling function execute ...____________________Profiling function execute ...")
    print("Measuring for WRITE/READ parquet dfS WorldTemp ... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"Executing duration Of Write and Read parquet for WorldTemp is ... : {a}")
    # ____________________end for Profiling a function execute ...
...
#____________________vvv____________________vvv____________________vvv____________________vvv
# profiling purpose
# __________measuring...__________measuring...__________measuring...__________measuring...
    # start_time = datetime.now()
    # ...
    # end_time = datetime.now()
    # a = (str(end_time - start_time)).split(".")[0]
...
def main():
    ...
    print("\n INCLUDED PROFILING CHECK TIME EXECUTION FOR WHOLE PROCESS......................")
    print("Measuring time POINT MARK HERE... \n")
    start_time = datetime.now()
    ...
    print(f"Start Time: {start_time.strftime('%H:%M:%S')}")
    print(f"End Time: {end_time.strftime('%H:%M:%S')}")
    print(f"EXECUTION TIME FOR WHOLE PROCESS IS  ... : {a}")
    # ____________________end for Profiling a function execute ...
